...
// 统一管理接口
enum API {
  CREATE = "/v1/system/menuButton/create",
  IMPORT = "/v1/system/menuButton/import",
  DELETE = "/v1/system/menuButton/delete/",
  BATCH_DELETE = "/v1/system/menuButton/delete/batchDelete",
